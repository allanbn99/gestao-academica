			...
			<div class="sky-login-body">
				<form method="post" action="{{ route('login') }}">
					...
					<div class="input-group flex-nowrap mb-3">
						...
						<input type="email" class="form-control bg-dark border-dark text-light" value="{{ old('email') }}" name="email" placeholder="Usuário" aria-label="Username" aria-describedby="addon-wrapping">
					</div>
					<div class="input-group flex-nowrap mb-3">
						<div class="input-group-prepend">
